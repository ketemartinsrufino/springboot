...
public class CadeSpringBootApplication {
	...
	@Autowired
	public CadeSpringBootApplication(ItemRepository itemRepository, ClasseRepository classeRepository,
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(CadeSpringBootApplication.class, args);
